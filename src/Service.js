                    ...
                    <div className='icon'>
                        ...
                        <div className='service__meta'>
                            ...
                            <p className='service__text p__color'>
                                HTML, CSS, JavaScript, ReactJS, Bootstrap, Node.js, MongoDB, Express.js etc
                            </p>
                ...
                <div className='col__3'>
                    ...
                    <div className='icon'>
                        ...
                        <h1 className='service__text'>
                            ...
                            <p className='service__text p__color'>
                                Data Structures and Algorithm, Object-Oriented Programming, Operating System, Database Management System
                            </p>
                        </div>
                    </div>
